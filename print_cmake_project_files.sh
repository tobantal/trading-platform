...
find . -type f \( -name "*.h" -o -name "*.hpp" -o -name "*.cpp" -o -name "CMakeLists.txt" -o -name "*.yml" -o -name "Dockerfile" -o -name "nginx.conf" -o -name "config.json" \) | sort | while read -r file; do
