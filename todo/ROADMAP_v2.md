...
1.1 Доработка TradingApp.cpp (хэндлеры) 30 мин
1.2 Тесты на новые хэндлеры (Account) 1 час
1.3 Исправление CI (GitHub Actions) 1 час
1.4 Проверка docker-compose up 1 час
1.5 MetricsHandler — привести в порядок 1 час
1.6 RabbitMQ: добавить в docker-compose 30 мин
1.7 RabbitMQ: IRabbitMQAdapter + реализация 2-3 часа
1.8 Prometheus: проверить scraping 30 мин
1.9 PostgreSQL: схемы + репозитории 3-4 часа
...
2.5 Docker Compose для 3 сервисов1-2 часа
...
3.3 UI: Register + Login1.5 часа
3.4 UI: Portfolio + Quotes1.5 часа
...
Начинаем с **Этапа 0.1: Регистрация недостающих хэндлеров**.

Готов сгенерировать патч для `TradingApp.cpp`?
