 ...
 * 
 * Либо используйте startDeferred() который автоматически 
 * делает binding при каждом subscribe().
 */
...
public:
        ...
        , handler_(ioContext_)
    {
        ...
        // НЕ вызываем start() здесь! Ждём пока subscribe() зарегистрирует handlers.
    }
