...
public:
    DbSettings() {
        host_ = getEnvOrDefault("DB_HOST", "localhost");
        port_ = std::stoi(getEnvOrDefault("DB_PORT", "5432"));
        name_ = getEnvOrDefault("DB_NAME", "broker_db");
        user_ = getEnvOrDefault("DB_USER", "broker");
        password_ = getEnvOrDefault("DB_PASSWORD", "broker123");
    }
